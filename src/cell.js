(function() {
  var E, cell, document, exports, window, _bind, _createDiv, _fnode, _isArray, _isNode, _modNameRx, _parseHAML, _range, _renderNodes;
  ...
  window.cell = cell = (function() {
    ...
    function cell(options) {
      var className, evSel, event, handler, i, id, m, n, nodes, _len, _ref, _ref2;
      ...
      if (className = className.trim()) this.el.className = className;
    ...
    cell.prototype._ = function() {
      var a, b, cell_options, children, className, el, haml, id, k, opts, parent, tag, v;
        ...
        parent = (function() {
          ...
          if (typeof a === 'string') {
            if (haml = _parseHAML(a)) {
              tag = haml.tag, id = haml.id, className = haml.className;
              ...
              if (b) {
                if ((b != null ? b.constructor : void 0) !== Object) {
                  ...
                  if ('class' in b) el.className += b["class"];
                  for (k in b) {
                    v = b[k];
            ...
            cell_options = typeof b === 'string' && (haml = _parseHAML(b)) ? (opts = (((_ref = children[0]) != null ? _ref.constructor : void 0) === Object) && children.shift() || {}, opts.id = haml.id, opts["class"] = haml.className, opts) : (b != null ? b.constructor : void 0) === Object ? b : void 0;
