...
define('models/Todo',[], function() {
  var NAUGHTY_WORDS, Todo, sanitize;
...
define('helpers/LocalStorage',[], function() {
  return Backbone.LocalStorage;
});

// Generated by CoffeeScript 1.3.1

define('models/TodoList',['models/Todo', 'helpers/LocalStorage'], function(Todo, LocalStorage) {
  var TodoList;
...
require(['cell'],function(p){
  p.__preinstalledCells__ = {"views/TodoApp":0,"views/TodoView":0,"views/Stats":0};
});

// Generated by CoffeeScript 1.3.1
var __slice = [].slice;

define('views/TodoApp',['models/TodoList', 'cell!./TodoView', 'cell!./Stats'], function(TodoList, TodoView, Stats) {
  return {
    todos: new TodoList(),
    on: {
      "keypress #new-todo": function() {
        var event;
        event = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return this.createOnEnter.apply(this, event);
      },
      "keyup #new-todo": function() {
        var event;
        event = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return this.showTooltip.apply(this, event);
      },
      "click .todo-clear a": function() {
        var event;
        event = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return this.clearCompleted.apply(this, event);
      }
    },
    init: function() {
      this.todos.fetch();
      this.todos.bind('add', this.addOne, this);
      return this.todos.bind('reset', this.addAll, this);
    },
    ...
    render: function(_) {
      return [
        _('h1', "Todos"), _('.content', _('#create-todo', _('input#new-todo', {
          placeholder: "What needs to be done?",
          type: "text"
        }), _('span.ui-tooltip-top', {
          style: "display:none;"
        }, 'Press Enter to save this task'))), _('#todos', _('ul#todo-list')), _(Stats, {
          model: this.todos
        })
      ];
    },
    ...
    addOne: function(todo) {
      return this.$("#todo-list").append(this._(TodoView, {
        model: todo
      }));
    },
    addAll: function() {
...
define('views/TodoView',[], function() {
  return {
    tag: "<li>",
    on: {
      "click .check": function() {
        ...
        return this.toggleDone.apply(this, e);
      },
      "dblclick div.todo-text": function() {
        var e;
        e = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return this.edit.apply(this, e);
      },
      "click span.todo-destroy": function() {
        var e;
        e = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return this.clear.apply(this, e);
      },
      "keypress .todo-input": function() {
        var e;
        e = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return this.updateOnEnter.apply(this, e);
      },
      "blur .todo-input": function() {
        var e;
        e = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return this.close.apply(this, e);
      }
    },
    init: function() {
      var _this = this;
      this["class"] = this.model.get('done') && 'done' || '';
      this.model.bind('destroy', this.remove, this);
      return this.model.bind('change', function() {
        return _this.$el.empty().append(_this.render(_this._));
      });
    },
    render: function(_) {
      var checkbox_attrs, text;
      ...
      return [
        _('div', {
          "class": 'todo' + (this.model.get('done') ? ' done' : '')
        }, _('.display', _('input.check', checkbox_attrs), _('.todo-text', text), _('span.todo-destroy')), _('.edit', this.input = $(_('input.todo-input', {
          type: "text",
          value: text
        }))))
      ];
    ...
    toggleDone: function() {
      this.model.toggle();
      return this.$el.toggleClass('done', this.model.get('done'));
    },
    edit: function() {
  ...
  return {
    init: function() {
      ...
      return this.model.bind('all', function() {
        return _this.$el.empty().append(_this.render(_));
      });
    },
    render: function(_) {
      var num_done, remaining;
      return [
        this.model.length ? _('span.todo-count', _('span.number', remaining = this.model.remaining().length), _('span.word', (remaining === 1 ? ' item' : ' items') + ' left')) : void 0, (num_done = this.model.done().length) ? _('span.todo-clear', _('a', {
          href: "#"
        }, 'Clear ', _('span.number-done', num_done), _('span', ' completed'), _('span.word-done', num_done === 1 ? ' item' : ' items'))) : void 0
      ];
    }
  };
});
...
define("backbone_localStorage", function(){});
